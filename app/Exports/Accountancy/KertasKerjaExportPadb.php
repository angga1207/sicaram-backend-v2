        ...
        if ($this->params['type'] == 'beban_barjas') {
            ...
            foreach ($collectDatas as $data) {
                $datas[] = [
                    ...
                    $data['no_kontrak'],
                    $data['tanggal_kontrak'] ? Carbon::parse($data['tanggal_kontrak'])->isoFormat('D MMMM Y') : null,
                    $data['periode_kontrak'],
                    $data['nilai_belanja_kontrak'],
                    $data['payment_1_sp2d'],
                    $data['payment_1_tanggal'] ? Carbon::parse($data['payment_1_tanggal'])->isoFormat('D MMMM Y') : null,
                    $data['payment_1_jumlah'],
                    $data['payment_2_sp2d'],
                    $data['payment_2_tanggal'] ? Carbon::parse($data['payment_2_tanggal'])->isoFormat('D MMMM Y') : null,
                    $data['payment_2_jumlah'],
                    $data['payment_3_sp2d'],
                    $data['payment_3_tanggal'] ? Carbon::parse($data['payment_3_tanggal'])->isoFormat('D MMMM Y') : null,
                    $data['payment_3_jumlah'],
                    $data['payment_4_sp2d'],
                    $data['payment_4_tanggal'] ? Carbon::parse($data['payment_4_tanggal'])->isoFormat('D MMMM Y') : null,
