...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_persediaan_belanja_persediaan_untuk_dijual', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('acc_persediaan_belanja_persediaan_untuk_dijual');
    }
};
