...
return new class extends Migration
{
    ...
    {
        Schema::create('target_perubahan_tujuan', function (Blueprint $table) {
            ...
            $table->foreign('parent_id')->references('id')->on('target_tujuan');
    ...
    {
        Schema::dropIfExists('target_perubahan_tujuan');
    }
};
