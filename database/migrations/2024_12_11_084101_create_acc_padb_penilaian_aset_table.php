...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_padb_penilaian_aset', function (Blueprint $table) {
            ...
            $table->text('metode_perolehan')->nullable();
            $table->double('nilai_awal_aset')->nullable();
            $table->double('hasil_penilaian')->nullable();
    ...
    {
        Schema::dropIfExists('acc_padb_penilaian_aset');
    }
};
