...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_persediaan_barang_habis_pakai', function (Blueprint $table) {
            ...
            $table->double('beban_persediaan')->nullable();
    ...
    {
        Schema::dropIfExists('acc_persediaan_barang_habis_pakai');
    }
};
