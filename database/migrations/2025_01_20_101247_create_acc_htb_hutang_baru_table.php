...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_htb_hutang_baru', function (Blueprint $table) {
            ...
            $table->text('p4_nomor_sp2d')->nullable();
            $table->date('p4_tanggal')->nullable();
            $table->double('p4_jumlah')->nullable();
            ...
            $table->double('uang_jasa_diserahkan')->nullable();
            ...
            $table->double('beban')->nullable();
            $table->double('jangka_pendek')->nullable();
    ...
    {
        Schema::dropIfExists('acc_htb_hutang_baru');
    }
};
