...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_padb_tambahan_hibah_keluar', function (Blueprint $table) {
            ...
            $table->text('penerima_hibah')->nullable();
            $table->text('pemberi_hibah')->nullable();
    ...
    {
        Schema::dropIfExists('acc_padb_tambahan_hibah_keluar');
    }
};
